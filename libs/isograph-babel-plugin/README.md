...
This package changes calls to `iso` to `require` calls for the generated artifact. For example, `` isoFetch`Query.home_page` `` might get replaced with `require("../__isograph/Query/home_page/entrypoint.isograph.ts")`.
